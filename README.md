...
| <a name="input_fluentbit_additial_exclude_from_application_log_group"></a> [fluentbit\_additial\_exclude\_from\_application\_log\_group](#input\_fluentbit\_additial\_exclude\_from\_application\_log\_group) | List of application logs to exclude log group | `list(string)` | `[]` | no |
| <a name="input_fluentbit_additial_include_in_platform_log_group"></a> [fluentbit\_additial\_include\_in\_platform\_log\_group](#input\_fluentbit\_additial\_include\_in\_platform\_log\_group) | List of platform logs to include log group | `list(string)` | `[]` | no |
